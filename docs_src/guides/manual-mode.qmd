...
| Control | Description |
|---------|-------------|
| **C~L~ Model** | Lift coefficient model: *Nathan 2020 (exp)* (default) or *Rational (old)*. See [Statcast Mode — Physics Model Options](statcast-mode.qmd#physics-model-options) for details. |
